...
# Mock values for SSH connection tests
MOCK_HOST = "test-host"
...
def ssh_provider():
    ...
    with mock.patch(
        ...
        # Set up a basic mock pool with methods that return reasonable defaults
        mock_pool = mock_pool_class.return_value

        # Set up connection pool default behavior
        ...
        mock_connection.params.host = MOCK_HOST
        mock_connection.params.username = MOCK_USERNAME
        mock_connection.params.port = MOCK_PORT
        mock_connection.is_connected.return_value = True
        mock_connection.get_connection_info.return_value = MOCK_CONNECTION_INFO

        # Set up connection pool methods to return the mock connection
