...
def test_link_wallet_success(settings, mock_request):
...
def test_link_wallet_invalid_address(settings, mock_request):
...
def test_link_wallet_api_error(settings, mock_request):
